    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('passenger', 'Passenger'), ('station', 'Station'), ('admin', 'Admin'), ('driver', 'Driver')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('route', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.routes')),
            ],
        ),
        migrations.CreateModel(
            name='Transaction',
